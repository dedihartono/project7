...
INSERT INTO `m_obat` (`obat_id`, `obat_nama`, `pengertian`, `indikasi`, `kontradiksi`, `efek_samping`, `penggunaan`, `perhatian`, `dosis`, `kemasan`, `komposisi`) VALUES
...
(3, 'Acarbose', 'Acarbose merupakan kelompok obat antidiabetes terutama diabetes tipe 2, yang berfungsi mengontrol kadar gula darah dengan cara memperlambat proses pencernaan karbohidrat menjadi senyawa gula yang lebih sederhana. Obat ini membantu menurunkan kadar gula dalam darah setelah makan. Selain mengubah pola konsumsi makanan serta program olah gerak tubuh, para pengidap diabetes biasanya juga diberikan acarbose sebagai obat tambahan.', '', '', '', '', '', 'Umumnya, konsumsi acarbose pada masa awal pengobatan adalah 50 - 150 mg per hari. Jika tubuh penderita merespon pengobatan dengan baik, maka dalam rentang waktu minimal enam hingga delapan minggu dosis ditingkatkan menjadi 150 mg per hari. Untuk mendapatkan efek pengobatan maksimal, acarbose harus dikonsumsi secara teratur dan disesuaikan dengan pola konsumsi makanan penderita diabetes.', '', ''),
(4, 'test', '2', '3', '4', '5', '6', '7', '8', '9', '');
